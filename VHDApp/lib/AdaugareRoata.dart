...
class AdaugareRoataPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return AdaugareRoata();
  }
}

class AdaugareRoata extends State<AdaugareRoataPage> {
  Roata _roata = new Roata(tip: TipRoata.AllSeasons, marca: "Continental");
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text("Adauga Roata"), backgroundColor: Colors.deepOrange),
      body: ListView(
